 ...
 * Plugin URI: https://www.wordpres.org/mv-slider
 * Description: My plugin's description
 * Version: 1.0
 * Request at least: 5.6
 * Author: Luiz Eduardo Vitesse
 * Author URI: https://www.luizeduardovitesse.com
...
along with MV Slider. If not, see https://www.gnu.org/license/gpl-2.0.html
*/
    ...
    class MV_Slider {
        ...
        public function register_admin_scripts() {
            ...
            if($typenow == 'mv-slider') {
                wp_enqueue_style('mv-slider-admin-style', MV_SLIDER_URL . 'assets/css/admin.css');
            }
        }
